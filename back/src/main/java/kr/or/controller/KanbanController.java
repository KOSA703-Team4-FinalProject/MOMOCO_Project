...
public class KanbanController {
	...
	public ArrayList<ArrayList<Object>> getKanban(@RequestBody Kanban url) {
		...
		// 칸반 전체 조회
		kanban = kanbanservice.getKanban(url.getUrl());
	...
	public List<Board> getItemByStatus(@RequestParam(value = "url") String url,
			@RequestParam(value = "s_idx") int s_idx) {

		System.out.println("아이템 리스트");
		System.out.println(url);
		System.out.println(s_idx);
		List<Board> list = new ArrayList<Board>();
		list = kanbanservice.getItembyStatus(url, s_idx);
	...
	public int addKanbanColumn(@RequestBody Kanban kanban) {
		...
		int result = kanbanservice.addKanbanColumn(kanban);
	...
	public int deleteKanbanitem(@RequestBody Kanban kanban) {
		...
		int result = kanbanservice.deleteAllKanbanItem(kanban);

		return result;
	}

	// 칸반 아이템 삭제
	@RequestMapping(value = "KanbanItemDelete", method = RequestMethod.POST)
		public int kanbanItemDelete(@RequestBody Kanban kanban) {
			
			int result = kanbanservice.KanbanItemDelete(kanban);
	...
	public int deleteKanbancolumn(@RequestBody Kanban kanban) {
		...
		int result = kanbanservice.deleteKanbanColumn(kanban);
	...
	public int modifykanbanColumnName(@RequestBody Kanban kanban) {
		...
		int result = kanbanservice.modifyKanbanColumnName(kanban);
	...
	public Kanban getBoardByIdx(@RequestBody Kanban kanban) {
		...
		kanbandetail = kanbanservice.GetKanbanItemDetail(kanban);
		System.out.println(kanban.getB_idx());
		System.out.println(kanban.getUrl());
		System.out.println(kanbandetail);
		return kanbandetail;
