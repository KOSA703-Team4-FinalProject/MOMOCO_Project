import { CButton, CCard, CModal, CModalBody, CModalHeader } from '@coreui/react'
import { BsGithub } from 'react-icons/bs'
import $ from 'jquery'
import { useDispatch } from 'react-redux'
import { changeChatState, changeUserProfile } from 'src/store'
...
const Profile = (props) => {
  ...
  const profileMoal = props.profileMoal
  ...
  return (
    <CModal alignment="center" visible={profileMoal}>
