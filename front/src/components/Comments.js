import { CAvatar, CButton, CCard, CCol, CContainer, CForm, CFormTextarea, CRow } from "@coreui/react"
const boxsize ={
    ...
    <CCard style={boxsize}>
        <CRow>
          ...
          <CCol className="col-md-12">
            ...
            <CRow>
              <CCol className="col-md-12 mt-2 mb-2" align="end">
              <CButton color="primary" variant="outline">작성</CButton> &nbsp;
